...
- Will run on any web-browser

- Can be viewed on any screen size

- To see specific author details go to "Developer Tools" and then look at the console log after clicking on a node.  
